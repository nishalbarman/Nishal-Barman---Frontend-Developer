...
function HamBurger() {
  return (
    // bg-[#34300E]
    <div className="hidden max-[1113px]:flex z-[99] mt-10 relative  border-[1px] border-[#706F57] shadow-[0px_0px_10px_3px_#352F0E] items-center justify-between h-[88px] w-[94%] rounded-[16px] p-[0_2%] backdrop-blur-[10px] bg-[rgba(92,79,5,0.5)]">
