...
function Navbar() {
  return (
    <div className="z-[99] mt-10 relative bg-[#34300E] border-[1px] border-[#706F57] shadow-[0px_0px_10px_3px_#352F0E] flex items-center justify-between h-[88px] w-[94%] rounded-[16px] p-[0_2%]">
      ...
      <div className="flex items-center gap-[5rem]">
        <div className="flex gap-10">
          <Link className="text-[18px] font-inter" href={"/"}>
            About
          </Link>
          <Link className="text-[18px] font-inter" href={"/"}>
            Our Products
